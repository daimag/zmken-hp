    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero__copy">
          ...
          <div className="hero__cta">
            <Link className="btn btn--light" href="/v1/works">施工実績を見る</Link>
            <Link className="btn btn--light" href="/v1/branding">空間プロデュース</Link>
          </div>
        </div>
      ...
      <section className="section">
        ...
        <div className="wrap mt-32">
          <WorksMosaic limit={8} />
          <p className="center mt-32"><Link className="btn btn--ghost" href="/v1/works">施工実績をすべて見る</Link></p>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="wrap feature feature--rev">
          ...
          <div className="feature__body">
            ...
            <p className="mt-20"><Link className="btn" href="/v1/branding">詳しく見る</Link></p>
          </div>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="wrap feature">
          ...
          <div className="feature__body">
            ...
            <p className="mt-20"><Link className="btn" href="/v1/consulting">相談してみる</Link></p>
          </div>
        </div>
      </section>
      ...
      <section className="section section--soft">
        ...
        <div className="wrap mt-32">
          ...
          <p className="center mt-32"><Link className="btn btn--ghost" href="/v1/about">私たちについて</Link></p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap">
          <div className="contact-box">
            ...
            <Link className="btn" href="/v1/contact">お問い合わせフォーム</Link>
          </div>
        </div>
      </section>
    </>
